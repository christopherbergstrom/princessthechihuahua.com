...
class FormBuilderFrameworkBootstrap5 extends FormBuilderFramework {
	...
	public function load() {
		...
		$config->styles->append($config->urls->FormBuilder . 'frameworks/FormBuilderFrameworkBootstrap5.css');
	...
	public function getConfigDefaults() {
		...
		$bootURL = str_replace($urls->root, '/', $urls->FormBuilder . 'frameworks/bootstrap5/');
